...
setMethod(f="GrapleRunExperiment",
          ...
          definition=function(grapleObject, filterName)
          {
            ...
            else
            {
              ...
              postresp = postForm(qurl, .params = params, files=fileUpload(tarfile), ssl.verifypeer = FALSE, ssl.verifyhost = FALSE)
...
setMethod(f="GrapleCheckExperimentCompletion",
          ...
          definition=function(grapleObject)
          {
            ...
            grapleObject@StatusCode <- -1
            status <- fromJSON(getForm(qurl, apikey=grapleObject@APIKey, ssl.verifypeer = FALSE, ssl.verifyhost = FALSE))
...
setMethod(f="GrapleGetExperimentResults",
          ...
          definition=function(grapleObject)
          {
            ...
            else if(getResultsDirName(grapleObject) %in% list.files(grapleObject@ResultsDir))
            {
              ...
              grapleObject@StatusCode <- -1
              getresp <- getForm(qurl, apikey=grapleObject@APIKey, ssl.verifypeer = FALSE, ssl.verifyhost = FALSE)
...
setMethod(f="GrapleEndExperiment",
          ...
          definition=function(grapleObject)
          {
            ...
            status<- getForm(qurl, apikey=grapleObject@APIKey, ssl.verifypeer = FALSE, ssl.verifyhost = FALSE)
